				...
				<Formik initialValues={{
					...
					{({errors, touched, values, isSubmitting}) => (
						<Form className="registerForm">
							...
							<Field as={Input} style={{backgroundColor: "#4d4d4d", color: "#ffffff", width: '100%'}} name='email'
							       required
							       error={errors.email && touched.email ? errors.email : null}/>

							<DialogContentText style={{color: "#fff0f0"}}>Password:</DialogContentText>
							<Field as={Input} style={{backgroundColor: "#4d4d4d", color: "#ffffff", width: '100%'}} name='password'
							       type="password"
							       required
